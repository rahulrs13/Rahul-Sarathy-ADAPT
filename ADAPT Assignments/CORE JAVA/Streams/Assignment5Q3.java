...
public class Assignment5Q3 {
	public static void main(String[] args) {
		Trader t1=new Trader("Adesh", "Chennai");
		Trader t2=new Trader("Rahul", "Banglore");
		Trader t3=new Trader("Gopi", "Patna");
		Trader t4=new Trader("Jithin", "Kanpur");
		Trader t5=new Trader("Shyam", "Banglore");
		Trader t6=new Trader("Aryan", "Delhi");
